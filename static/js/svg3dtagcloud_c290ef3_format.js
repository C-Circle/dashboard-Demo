...
function() {
    function t(t, e) {
        ...
        function s(t, e, n, i, o) {
            ...
            r.element.setAttribute("fill", e.color || p.fontColor),
        ...
        function c(t, e) {
            for (var n = a(t), i = 0, o = S.length; i < o; i++) {
                var r = S[i];
                r.index === n.index ? (!r.mouseOver && e && r.element.setAttribute("opacity", p.opacityOver), r.mouseOver = !0) : (r.mouseOver && e && r.element.setAttribute("opacity", p.opacityOut), r.mouseOver = !1)
            }
        }
        function l() {
        ...
        function() {
            ...
            t.appendChild(A),
            p.bgDraw && (P = document.createElementNS(D, "rect"), P.setAttribute("x", 0), P.setAttribute("y", 0), P.setAttribute("fill", p.bgColor), A.appendChild(P)),
            u(),
            i(),
            d(),
